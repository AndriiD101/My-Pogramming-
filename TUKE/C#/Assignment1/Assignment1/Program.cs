...
namespace Assignment1
{
    internal class Program
    {
        ...
        public static List<Purchase> LoadPurchases(string path)
        {
            ...
            Dictionary<string, Recording> recordingsByCode = recordings.ToDictionary(r => r.GetCode());
            ...
            //Console.WriteLine(recordingsPath);
            //Console.WriteLine("Congrats done correctly!!!");
            return purchases;
        }
        ...
        {
            string filePathPurchases = @"C:\Users\denys\Desktop\My-Pogramming-\TUKE\C#\Assignment1\Assignment1\samples\purchases01.csv";
            string filePathRecordings = @"C:\Users\denys\Desktop\My-Pogramming-\TUKE\C#\Assignment1\Assignment1\samples\recordings01.csv";
            ...
            //var toPrint = GetAveragePiecePrice(filePathPurchases, "Violin Sonata No. 9 in A major
